...
import com.lotche.custom.CustomActivity;
import com.lotche.custom.CustomCollection;
import com.lotche.custom.CustomFragment;
import com.lotche.model.Data;
import com.lotche.test.CategoryFragment;
import com.lotche.ui.Checkout;
import com.lotche.ui.LeftNavAdapter;
import com.lotche.ui.MainFragment;
import com.lotche.ui.OnSale;
...
public class MainActivity extends CustomActivity implements ProductDetailsListener,MainFragment.OnFragmentInteractionListener,CategoryFragment.OnFragmentInteractionListener
{
	...
	public ArrayList<CustomCollection> collectionArrayList;
	private int count ;
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		if (getIntent()!=null){
			count = getIntent().getIntExtra(Login.COUNT,0);
		}

		setupDrawer();
		setupContainer(count);
	...
	private void setupContainer(int pos)
	{
		...
		if (pos == 0)
		{
			...
			f = MainFragment.newInstance(collectionArrayList,"");
		else if (pos == 2)
		{
			f = new OnSale();
			title = "On Sale";
		...
		drawerLayout.closeDrawers();
		final CustomFragment finalF = f;
		final String finalTitle = title;
		new Handler().postDelayed(new Runnable() {
			@Override
			public void run() {
				getSupportFragmentManager().beginTransaction()
						.replace(R.id.content_frame, finalF).commit();
			}
		}, 300);
