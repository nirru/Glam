...
import com.lotche.utils.ImageUtility;
...
////					: View.VISIBLE);
            ...
            ((EventViewHolder) holder).lbl2.setText("" + new Double(salesPrice).intValue());
               ((EventViewHolder) holder).lbl3.setText(((Product)dataItem1).getProductType());
            ...
            if (((Product)dataItem1).getOptions().isEmpty() || ((Product)dataItem1).hasDefaultVariant() || ((Product)dataItem1).getVariants().isEmpty()) {
                ((CartListAdapter.EventViewHolder) holder).lbl6.setVisibility(View.GONE);
                ((CartListAdapter.EventViewHolder) holder).lbl7.setVisibility(View.GONE);
            }else{
                ((CartListAdapter.EventViewHolder) holder).lbl6.setVisibility(View.VISIBLE);
                ((CartListAdapter.EventViewHolder) holder).lbl7.setVisibility(View.VISIBLE);
                ((CartListAdapter.EventViewHolder) holder).lbl7.setText(((ProductVariant)dataItem).getOptionValues().get(0).getValue());
            }
...
//                        }
    ...
    public static class EventViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        /** The textviews. */
        protected TextView lbl1, lbl2, lbl3, lbl4,lbl5,lbl6,lbl7;
        ...
        public EventViewHolder(View v) {
            ...
            lbl6 = (TextView)v.findViewById(R.id.lbl6);
            lbl7 = (TextView)v.findViewById(R.id.lbl7);
